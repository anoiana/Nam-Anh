...
This group comprises the PrPoS and the PRCoS. The idea is similar to the posterior group, the only difference lies at `r lb(eq.1)` that will be used in lieu of `r lb(eq.2)`. 
