...
&\Rightarrow \ln(np_i) +n -\alpha_0 -\alpha_1(x_i) = 0 \\
&\Rightarrow \ln(np_i) = \alpha_1(x_i)+\alpha_0 -n \\
&\Rightarrow p_i = \frac{\exp[\alpha_0+\alpha_1(x_i)-n]}{n} \\
&\Rightarrow p_i = \frac{e^{-n}}{n}\exp[\alpha_0+ \alpha_1(x_i)]
\end{aligned}
(\#eq:eq2)
$$
...
$$
\begin{aligned}
&\quad 1 = \sum_{i=1}^np_i = \frac{e^{-n}}{n}\sum_{i=1}^n\exp[\alpha_0+\alpha_1(x_i)] \\
& \Rightarrow \frac{n}{e^{-n}} = \sum_{i=1}^n\exp[\alpha_0+ \alpha_1(x_i)]
\end{aligned}
(\#eq:eq3)
$$
